...
function isFunctionDeclarationMatched(D) {
    let node = D.node
    let attribs = D.attribs
    let funcs = D.funcs
...
var rslts = srch(ast,mat,"ArrowFunctionDeclaration",isFunctionDeclarationMatched,attribs,funcs)
let s = rslts.join("\n================================\n")
...
Node {
  ...
  generator: false,
  async: false,
  params: [ Node { type: 'Identifier', start: 1, end: 2, name: 'r' } ],
  body: Node { type: 'Literal', start: 6, end: 9, value: 's', raw: '\'s\'' } }
>
